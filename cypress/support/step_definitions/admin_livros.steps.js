...
When(`eu adicionar um livro com os dados obrigatorios`, () => {
...
When("eu tento adicionar um livro sem preencher o título", () => {
    cy.adicionarLivroSemTitulo()
})

Then("o campo título deve ser obrigatório", () => {
